...
EM assigned 613 cards (75.9\%) to existing L3 categories. The remaining 195 cards (24.1\%) were routed to domain-specific Others queues for human decision because of ambiguity between eligible current L3 candidates, weak anchor support, instability, or bilingual disagreement. The final distribution is 618 General, 78 Agentic, and 112 Physical. All 46 source L3 rows remain unchanged, with three derived Others routing rows. All 47 internal validation checks passed.
...
General AI & 591 & 618 & +27\\ Agentic AI & 83 & 78 & -5\\ Physical AI & 218 & 112 & -106\\\midrule Total & 892 & 808 & -84\\\bottomrule\end{tabular}\end{table}
...
General AI & 618 & 457 & 161 & 26.1\%\\ Agentic AI & 78 & 65 & 13 & 16.7\%\\ Physical AI & 112 & 91 & 21 & 18.8\%\\\midrule Total & 808 & 613 & 195 & 24.1\%\\\bottomrule\end{tabular}\end{table}
...
The pre-keyword baseline contained 559 EM assignments and 266 HD records. Keyword augmentation and L3-referenced definition review increased the final EM count to 613, a net recovery of 54 records. Wage polarisation was recovered to G\_SOC\_ECON and cybercrime misuse at scale to G\_SYS\_SECADV. The remaining 195 HD records represent explicit uncertainty preservation and must not be interpreted as automatically confirmed L3 assignments.
...
\section{Limitations}
The method is anchor-constrained spherical hard EM rather than a full probabilistic mixture-model EM. Thresholds are internal operating rules and have not been calibrated on an external expert-labelled sample. The 195 Others records form a human-decision queue, not a deletion set. Independent validation should use samples stratified by domain, L3, score, margin, and decision route.

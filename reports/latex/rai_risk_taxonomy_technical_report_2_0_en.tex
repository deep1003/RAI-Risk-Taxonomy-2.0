...
of taxonomy placement. L1 membership is communicated through both an explicit
text badge and a visual color: blue for General-purpose AI, green for Agentic
AI, and red for Physical AI. The color is derived from the card's current L1
...
color as the sole carrier of categorical information.
...
release validator reports 71 PASS, 0 FAIL, and 2 WARN, and all 31 repository

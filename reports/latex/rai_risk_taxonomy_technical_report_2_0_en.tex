...
classification procedure assigns all 1,726 cards (100.0\%) to 50 L3 nodes and
...
AI-risk records, 1,726 canonical L4 cards, and 1,726 L3-assigned cards.
...
The final policy view assigns all 1,726 L4 cards to one of 50 L3 nodes
...
L3 assigned & 1,726 & Risk card & Protected Physical mapping or staged non-Physical placement; all 55 difficult cases remain assigned and marked \code{HOLD}. \\
\bottomrule
\end{tabularx}
\end{table}
...
The final policy assigns all 1,726 cards (100.0\%); 55 assigned cards (3.2\%)
carry the \code{HOLD} marker. Of all cards, 1,192 are General, 352 are Agentic
AI, and 182 are Physical AI. Their shares are 69.1\%, 20.4\%, and 10.5\%, respectively.
...
\addplot[fill=natureblue, draw=natureblue] coordinates {
 ...
 (90,Privacy) (89,Policy Exposure) (110,Misinformation/Disinformation)

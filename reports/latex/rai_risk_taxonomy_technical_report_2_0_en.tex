...
L3 nodes and preserve an operational path for every card. The release contains
1,173 General, 356 Agentic, and 182 locked Physical cards. Thirty-one cards move
into four new Agentic-specific L3 families; 685 cards (40.0\%) remain marked
...
seven review markers, leaving 685 cards (40.0\%) marked \code{HOLD}. The marker
...
L3 assigned & 1,711 & Risk card & Protected Physical mapping or staged non-Physical placement; 685 decision-required cards remain assigned and marked \code{HOLD}. \\
\bottomrule
\end{tabularx}
\end{table}
...
preserved, and the final review queue contains 685 cards.
...
The final policy assigns all 1,711 canonical cards (100.0\%); 685 assigned
cards (40.0\%) carry the \code{HOLD} marker. Of all cards, 1,173 are General,
356 are Agentic AI, and 182 are Physical AI. Their shares are 68.6\%, 20.8\%,
and 10.6\%, respectively. All 54 L3 nodes contain at least one card.
Anthropomorphism is the largest L3 with 245 cards (14.3\%); the five largest
L3 nodes jointly contain 41.4\%.
...
\addplot[fill=natureblue, draw=natureblue] coordinates {
 (59,Weaponization) (60,Conflict) (62,Excessive Authority)
 (69,Destabilising Dynamics) (77,Network Effects)
 (88,Privacy) (88,Policy Exposure) (110,Misinformation/Disinformation)
 (117,Copyrights) (149,Goal Misalignment) (245,Anthropomorphism)
};
\end{axis}
\end{tikzpicture}
...
decision-required share is 40.0\%. Exact floating-point ratios remain available in the
...
The 685 assigned cards marked \code{HOLD} should be adjudicated using agreement
...
\begin{itemize}[leftmargin=2em]
  ...
  \item \small\nolinkurl{public/data/releases/v2.8.0/cards.json}
  \item \small\nolinkurl{public/data/releases/v2.8.0/hierarchy.json}

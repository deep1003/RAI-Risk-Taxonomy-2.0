...
agreement, a conditional subset result rather than a like-for-like accuracy
...
These are not before--after accuracy estimates on the same population. The
...
\begin{itemize}[leftmargin=2em]
  ...
  \item \small\nolinkurl{public/data/releases/v2.15.0/cards.json}
  \item \small\nolinkurl{public/data/releases/v2.15.0/hierarchy.json}
  \item \small\nolinkurl{public/data/releases/v2.15.0/manifest.json}
  \item \small\nolinkurl{reports/data_quality/hold_l2_overlay_v2.15.0/summary.json}
  \item \small\nolinkurl{reports/data_quality/hold_l2_overlay_v2.15.0/hold_path_moves.json}
  ...
  \item \small\nolinkurl{reports/validation/v2.15.0/non_hold_reliability/reliability_summary.json}
  \item \small\nolinkurl{reports/validation/v2.15.0/non_hold_reliability/per_l3_metrics.json}
  \item \small\nolinkurl{reports/validation/v2.15.0/non_hold_reliability/non_hold_reliability.pdf}
  ...
  \item \small\nolinkurl{scripts/create_hold_l2_overlay_v2_15.py}
  \item \small\nolinkurl{scripts/validate_non_hold_reliability_v2_15.py}
\end{itemize}

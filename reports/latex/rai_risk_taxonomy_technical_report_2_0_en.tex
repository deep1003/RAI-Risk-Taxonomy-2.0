...
classification procedure assigns all 1,725 cards (100.0\%) to 50 L3 nodes and
marks 55 cards (3.2\%) as requiring a taxonomy decision. We specify the
...
(100.0\%). Fifty-five difficult cards (3.2\%) retain a \code{decision\_required}
...
L3 assigned & 1,725 & Risk card & Protected Physical mapping or staged non-Physical placement; all 55 difficult cases remain assigned and marked \code{HOLD}. \\
\bottomrule
\end{tabularx}
\end{table}
...
their forced L3 path remains populated and \code{decision\_required=true}. The
...
The final policy assigns all 1,725 canonical cards (100.0\%); 55 assigned cards (3.2\%)
...
the twelve largest L3 nodes. Counts include the 55 assigned cards marked
\code{HOLD}.}
\label{fig:l3}
\end{figure}
...
decision-required share is 3.2\%. Exact floating-point ratios remain available in the
...
The 55 assigned cards marked \code{HOLD} should be reviewed first, beginning with the 23
...
\begin{itemize}[leftmargin=2em]
  ...
  \item \small\nolinkurl{public/data/releases/v2.1.0/cards.json}

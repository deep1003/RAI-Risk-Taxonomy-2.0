...
\section{Stage 3 통계 요약}

\subsection{L1 및 L2 분포}
...
\midrule
\endhead
L1 & RAI1-G & General & 1,192 & 69.0614\% \\
L1 & RAI1-A & Agentic AI & 352 & 20.3940\% \\
L1 & RAI1-P & Physical AI & 182 & 10.5446\% \\
\midrule
L2 & RAI2-G-INT & Interaction & 751 & 43.5110\% \\
L2 & RAI2-G-SYS & System & 441 & 25.5504\% \\
L2 & RAI2-A-SYS & Agentic System & 352 & 20.3940\% \\
L2 & RAI2-P-SYS & Physical System Safety & 91 & 5.2723\% \\
L2 & RAI2-P-INT & Physical Interaction Safety & 62 & 3.5921\% \\
L2 & RAI2-P-SOC & Physical Societal Safety & 29 & 1.6802\% \\
\bottomrule
\end{longtable}

50개 L3 모두 최소 한 건을 포함한다. L3별 중앙 카드 수는 17개이며,
상위 5개 L3가 725개(42.0046\%)를 차지한다. HHI는 0.057524다.
이 값들은 분포의 집중도를 설명하는 기술통계이며, 각 배치의 정확도를 의미하지 않는다.

\subsection{강제 매칭 173건의 분포}

강제 매칭은 General 132건(76.3006\%), Agentic AI 41건(23.6994\%)이며
Physical AI L3로의 강제 매칭은 0건이다. L2 기준으로 General Interaction
96건(55.4913\%), Agentic System 41건(23.6994\%), General System
36건(20.8092\%)이다. 24개 L3에 강제 카드가 배치됐고 상위 5개가
79건(45.6647\%)을 차지했으며 강제 집합 HHI는 0.067927이다.

\begin{longtable}{llrr}
\toprule
L3 ID & L3 이름 & 강제 수 & 강제 집합 비율 \\
\midrule
\endhead
RAI3-G-INT-10 & Anthropomorphism & 26 & 15.0289\% \\
RAI3-G-INT-08 & Copyrights & 18 & 10.4046\% \\
RAI3-G-INT-09 & Weaponization & 12 & 6.9364\% \\
RAI3-A-SYS-04 & Destabilising Dynamics & 12 & 6.9364\% \\
RAI3-A-SYS-03 & Network Effects & 11 & 6.3584\% \\
RAI3-G-INT-11 & Policy Exposure & 10 & 5.7803\% \\
RAI3-G-INT-06 & Privacy & 9 & 5.2023\% \\
RAI3-G-INT-02 & Sexual & 9 & 5.2023\% \\
RAI3-G-SYS-07 & Overconfidence & 8 & 4.6243\% \\
RAI3-G-SYS-08 & Goal Misalignment & 7 & 4.0462\% \\
\bottomrule
\end{longtable}

상태별로는 Physical 잠금 182건, Stage 1 합의 제안 37건, Stage 2 제안
1,334건, Stage 3 강제 매칭 173건이다. 강제 매칭 중 critical 55건과 high
118건은 모두 \code{requires\_human\_review=true}이며, 통계상 100\% 커버리지는
사람 승인률 100\%가 아니다.
...
\begin{itemize}[leftmargin=2em]
  ...
  \item \nolinkurl{reports/statistics/stage3_l3_statistics.csv}

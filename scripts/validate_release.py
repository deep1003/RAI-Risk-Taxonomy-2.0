...
def main() -> None:
    ...
    if 'href="assets/site.css?v=2.12.0"' not in site_shell:
        site_contract_failures.append("css_link")
    if 'src="assets/site.js?v=2.12.0"' not in site_shell:
        site_contract_failures.append("js_link")
    if 'const DATA_ROOT = "public/data/releases/v2.12.0"' not in site_js:
    ...
    audit.add(
        "SITE-009",
        "Static HTML explorer targets the current v2.12.0 policy bundle",
        0,

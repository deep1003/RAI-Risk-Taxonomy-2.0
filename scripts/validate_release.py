...
def project_integrity_paths(
    ...
    return integrity_paths(
        ...
        PROJECT_ROOT / "public" / "data" / "releases" / "v2.1.0",
...
def main() -> None:
    ...
    if 'const DATA_ROOT = "public/data/releases/v2.1.0"' not in site_js:
    ...
    audit.add(
        "SITE-009",
        "Static HTML explorer targets the exact-deduplicated v2.1.0 policy bundle",
        0,

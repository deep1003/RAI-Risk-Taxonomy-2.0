...
class ReleaseSmokeTests(unittest.TestCase):
    ...
    def test_static_html_explorer_targets_the_release_bundle(self) -> None:
        ...
        self.assertIn('href="assets/site.css?v=2.16.0"', index)
        self.assertIn('src="assets/site.js?v=2.16.0"', index)
        self.assertIn('const DATA_ROOT = "public/data/releases/v2.16.0"', script)

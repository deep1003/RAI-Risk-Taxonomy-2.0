...
- AC-17: Added 24 card-specific journal articles to current L4 cards after local scholarly-corpus retrieval, OpenAlex journal/core-source and abstract screening, Crossref bibliographic validation, and live DOI resolver checks. Reference-bearing cards increased from 160 to 176; no taxonomy content or mapping changed.
